                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form id="add_category_form" action="{{ route('games.update',['id'=>$game->id]) }}" method="post">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <label for="date">Date:</label>
                                            <input type="date" name="date" id="date" class="form-control" value="{{ $game->date }}">
                                        </div>
                                        <div class="col-lg-6">
                                            ...
                                            <input type="number" name="game_duration_in_minutes" id="game_duration_in_minutes"
                                                   class="form-control" value="{{ $game->game_duration_in_minutes }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-lg-6">
...
@push('scripts')
    ...
    <script src="{{ asset("assets/js/pages/crud/validations/recipes.js") }}"></script>
    <script>
        $('#member_id').select2();
    </script>
@endpush
